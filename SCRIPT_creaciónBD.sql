IF DB_ID('Empresa_Ambiental') IS NOT NULL
BEGIN
    ALTER DATABASE Empresa_Ambiental SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE Empresa_Ambiental;
END
GO

CREATE DATABASE Empresa_Ambiental;
GO

USE Empresa_Ambiental;
GO
...
CREATE TABLE participantes(
    ...
    razon_social VARCHAR(200) NULL,          -- NULL cuando el tipo es Ciudadano
    tipo VARCHAR(50) NOT NULL,
    correo VARCHAR(150) NOT NULL,
    contrasena VARCHAR(120) NOT NULL,        -- se recomienda almacenar el hash
    fecha_registro DATETIME NOT NULL,
    estado_cuenta VARCHAR(12) NOT NULL
);

-- direcciones y telefonos: multivaluados (uno o varios por participante)
